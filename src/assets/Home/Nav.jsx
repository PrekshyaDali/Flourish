...
export default function Nav() {
  return (
    <div className="fixed top-0 left-0 p-4 z-50 h-full flex flex-col w-28  items-center space-y-5 bg-[#FAFAFF]">
      ...
      <Link className="" to="/">
        <div className="shadow-lg max-w-24 px-4 py-2 bg-[#A8A8A8] hover:bg-[#F9B131] hover:active:bg-[#F9B131] text-sm text-white text-semibold rounded-lg flex flex-col items-center justify-center">
      ...
      <Link to="/social">
        <div className="shadow-lg px-4 py-2 bg-[#A8A8A8] hover:bg-[#F9B131] hover:active:bg-[#F9B131] text-sm text-white text-semibold rounded-lg flex flex-col items-center justify-center">
